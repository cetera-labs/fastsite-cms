            ...
            tpl  : Ext.create('Ext.XTemplate',
				'<div class="plugin">', 
					'<div class="panel x-panel-body-default" style="text-align: center">',                     
						'<a href="https://tochka.com/?referer1=50mrpCETERA&utm_source=pertners&utm_medium=50mrpCETERA" target="_blank" style="position: relative; color:#000; padding: 5px 10px; margin-top: 35px" class="x-btn x-btn-default-small x-noicon x-btn-noicon x-btn-default-small-noicon">'+_('Открыть счет в банке "Точка"')+'</a>',
					'</div>',
				'</div>',
				'<div class="plugin">', 
					'<div class="panel x-panel-body-default" style="text-align: center;background-color: #efffef">',                     
						'<a href="https://cetera.ru/webdevelopment/website/order-module" target="_blank" style="font-weight:bold;position: relative; color:#000; padding: 5px 10px; margin-top: 35px" class="x-btn x-btn-default-small x-noicon x-btn-noicon x-btn-default-small-noicon">'+_('Заказать модуль')+'</a>',
					'</div>',
				'</div>',				
				'<tpl for=".">',
