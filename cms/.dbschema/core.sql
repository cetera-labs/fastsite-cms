...
(4, 1, 'dat_update', 5,        'Edit date[ru=Дата редактирования]',1,    1, 1, 0, 6,  0, NULL, 0, NULL, NULL),
(3, 1, 'dat', 5,               'Creation date[ru=Дата создания]',    1,    1, 1, 0, 5,  0, NULL, 0, NULL, NULL),
(2, 1, 'idcat', 6,             'Section[ru=Раздел]',           0,    1, 1, 0, 8,  1008, NULL, 0, NULL, NULL),
(5, 1, 'tag', 3,               'Sort[ru=Сортировка]',       1,    1, 0, 1, 1,  0, 100, 0, NULL, NULL),
(6, 1, 'type', 3,              '',                 1,    1, 1, 0, 7,  0, NULL, 0, NULL, NULL),
...
(25, 4, 'visual_constructor', 14, 'Constructor[ru=Конструктор]', 1, 1, 0, 0, 15, 0, '', 0, '', NULL),

(38, 2, 'tag', 3,        'Sort[ru=Сортировка]',       1, 1, 0, 1, 1,  0, 100,  0, NULL, NULL),
(30, 2, 'login', 1,      'Login',                   255, 1, 1, 1, 2, 0, NULL, 0, NULL, NULL),
(31, 2, 'name', 1,       'Name[ru=Имя]', 255, 1, 0, 1, 3, 0, NULL, 0, NULL, NULL),
...
CREATE TABLE IF NOT EXISTS `dir_data` (
  ...
  `meta_keywords` varchar(1000) DEFAULT NULL,
  `meta_description` varchar(1000) DEFAULT NULL,
  `visual_constructor` longtext DEFAULT NULL,
  PRIMARY KEY (`id`)
);

INSERT INTO dir_data VALUES ( 1, 1, 'default', 'default', 7, '', 1, NOW(), 0, 1, 'themes/default', 1, '', '', '', '', NULL);
