...
Ext.define('Cetera.panel.MaterialTypes', {
    ...
    typesStore: Ext.create('Ext.data.Store', {
        ...
        proxy: {
            ...
            simpleSortMode: true,
            api: {
                read: '/cms/include/data_types.php',
                create: '/cms/include/action_types.php?action=type_create',
                update: '/cms/include/action_types.php?action=type_update',
                destroy: '/cms/include/action_types.php?action=type_delete'
            },
            reader: {
                type: 'json',
    ...
    initComponent : function() {
        ...
        this.fieldsStore = new Ext.data.JsonStore({
            ...
            proxy: {
                ...
                api: {
                    read:    '/cms/include/data_types.php?mode=fields',
                    destroy: '/cms/include/action_types.php?action=field_delete',
                    update:  '/cms/include/action_types.php?action=field_edit',
                },
                extraParams: {
                    'type_id': 0
                }
    ...
    fieldCall: function(action) {
        Ext.Ajax.request({
            url: '/cms/include/action_types.php',
            params: { 
                action: action, 
    ...
    buildTypesGrid: function() {
        ...
        return Ext.create('Ext.grid.Panel', {
            ...
            features: [{
                id: 'group',
                ftype: 'grouping',
                groupHeaderTpl: '<tpl if="name == 1">'+_('Встроенные типы')+'</tpl><tpl if="name == 0">'+_('Пользовательские типы')+'</tpl>',
        ...
        this.field_props = {
            ...
            type: new Ext.form.ComboBox({
                ...
                store: new Ext.data.JsonStore({
                    ...
                    proxy: {
                        type: 'ajax',
                        url: '/cms/include/data_types.php?linkable=1',
                        reader: {
                            type: 'json',
                            rootProperty: 'rows'
                        },
