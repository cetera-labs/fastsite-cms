...
4. Указываем местоположение файлов исходного кода для извлечения фраз для перевода. Для этого выбираем "Каталог -> Свойства ...". Переходим на вкладку "Папки с исходными файлами". Добавляем папку модуля. Сохраняем проект.
